...
-+----------()()---()------()()----()--()--()------()-----------------------/-\------------------------------
-+----------()-()--()()()--()--()--()--()--()()()--()()()-------------------|4|------------------------------
-+~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Version~Number~\~/~~~~~~~~Build~Number:~4.08.253
-+~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Edit~Number~:~253~~~~~
-============================================================================================================
*/
...
$_DB_Query_Kernel_Select_System_Settings						= $_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT->query("SELECT * FROM Cerberus_settings WHERE id='1'");
...
$_GLOBAL_LOCAL_SERVER_TIME_MICROSECONDS							= date("s");
...
*/
	...
	header("Location: ?$_INTERNAL_APPLICATION_MODULE_MEMBER=Login&Message=No_Member&$_GLOBAL_SYSTEM_SECURITY_CACHE_CIRCUMVENTION_HTR_RANDOM_STRING_GENERATION");
	exit;
